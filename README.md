...
[![GitHub Repo stars](https://img.shields.io/github/stars/artamananda/artamananda-my-id?style=social)](https://GitHub.com/artamananda/artamananda-my-id/stargazers/)
[![GitHub forks](https://img.shields.io/github/forks/artamananda/artamananda-my-id?style=social)](https://github.com/artamananda/artamananda-my-id/forks)
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/git/external?repository-url=https://github.com/artamananda/artamananda-my-id)
...
Facing issues? Check the [FAQ page](https://github.com/artamananda/artamananda-my-id/wiki) and do a search on past issues. Feel free to open a new issue if none has been posted previously.
...
- [Demo Blog](https://artamananda.my.id/) - this repo
...
[v1-blogs-showcase.webm](https://github.com/artamananda/artamananda-my-id/assets/28362229/2124c81f-b99d-4431-839c-347e01a2616c)
...
- [A markdown guide](https://artamananda.my.id/blog/github-markdown-guide)
- [Learn more about images in Next.js](https://artamananda.my.id/blog/guide-to-using-images-in-nextjs)
- [A tour of math typesetting](https://artamananda.my.id/blog/deriving-ols-estimator)
- [Simple MDX image grid](https://artamananda.my.id/blog/pictures-of-canada)
- [Example of long prose](https://artamananda.my.id/blog/the-time-machine)
- [Example of Nested Route Post](https://artamananda.my.id/blog/nested-route/introducing-multi-part-posts-with-nested-routing)
...
```bash
npx degit 'artamananda/artamananda-my-id'
```
...
layout: PostLayout
canonicalUrl: https://artamananda.my.id/blog/introducing-tailwind-nextjs-starter-blog
---
```
...
[MIT](https://github.com/artamananda/artamananda-my-id/blob/main/LICENSE) © [Timothy Lin](https://www.timlrx.com)
